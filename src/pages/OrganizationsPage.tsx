            ...
            <TableBody>
              {filteredOrganizations.map((org) => (
                <TableRow key={org.id}>
                  ...
                  <TableCell>
                    <span className="text-gray-900">{org._count?.users || 0}</span>
                  </TableCell>
                  <TableCell>
                    <span className="text-gray-900">{org._count?.connectors || 0}</span>
                  </TableCell>
                  <TableCell>
          ...
          <div className="flex items-center space-x-4">
            ...
            <label className="flex items-center">
              <input
                ...
                onChange={(e) => setFormData({ ...formData, allowModelChange: e.target.checked })}
                className="mr-2"
              />
